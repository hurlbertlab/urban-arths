...
Next steps: 
1. Map CC sites by LSM and land cover statistics.
2. Compare and look for correlations in land cover and LSM data across the different scales.
3. Start assessing correlations between landscape statistics and CC data - what CC statistics do we want to start with?